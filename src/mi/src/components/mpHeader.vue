  ...
  <view class="nav">
    ...
    <view
      ...
      :style="{
        ...
        backgroundImage: `url(${mysNavConfig.bgImage})`,
    ...
    >
      <view class="my_left_box" :style="{ height: btnHeight }">
        ...
        <view
          ...
          :style="{ height: btnHeight, paddingLeft: navBarLeft }"
        >
          <image class="nv_icon" :src="mysNavConfig.leftIconPath" />
          <view
            class="leftText"
      ...
      <view class="my_right_icon" :style="{ height: btnHeight }">
        <image
          v-if="mysNavConfig.rightIconPath"
          @tap="onRightClick"
          class="nv_icon"
...
<script>
/* 默认首页路径 */
const homePath = "page/index/index";
/* 默认首页图标路径 */
const homeIconPath =
  "https://6465-dev-6df05c-1256698985.tcb.qcloud.la/static/image/home.png?sign=1127a1b0581d47783ed0c588e43379cc&t=1655370380";
/* 默认返回图标路径 */
const backIconPath =
  "https://6465-dev-6df05c-1256698985.tcb.qcloud.la/static/image/back.png?sign=c73a548dc4ac2d77fbef99f4027c8cad&t=1655370366";
export default {
  props: {
    mysNavConfig: {
      type: Object,
  ...
  methods: {
    init() {
      ...
      if (!this.mysNavConfig.opacity) {
        this.opacity = 1;
        !this.mysNavConfig.isOpacity
          ? (this.opacity = 1)
          : ((this.mysNavConfig.navFixed = true), (this.opacity = 0));
      } else {
    ...
    initMP() {
      ...
      this.navBarHeight =
        gS.statusBarHeight + rectHeight + (rect.top - gS.statusBarHeight) * 2 + "px";
      // //console.log()
      // //console.log(gS,rect)

      uni.setStorageSync("navBarHeight", this.navBarHeight);
    },
    /* 点击左侧 */
    onLeftClick() {
