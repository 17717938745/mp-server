...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'existsProblem', label: store.state.label.existsProblem, labelKey: 'existsProblem', width: 334, type: ValueType.TextArea, showOverflow: true,},
  {value: 'solveScheme', label: store.state.label.solveScheme, labelKey: 'solveScheme', width: 334, type: ValueType.TextArea, showOverflow: true,},
