    ...
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; width: 595px;">
      ...
      >`
        <el-descriptions-item
            ...
            align="center"
            label-class-name="event-print-label description-print-border"
...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'opinion', labelKey: 'eventOpinion', width: 128,},
...
const handleGet = () => {
  httpGet(`douson/event`, {eventId: route.query.eventId}).then(
      (res: DataResult<any>) => {
        data.value = res.data || {}
...
const handleCopyLink = () => {
  const text = dousonFullUrl(`/industry/public/event?eventId=${route.query.eventId}`)
