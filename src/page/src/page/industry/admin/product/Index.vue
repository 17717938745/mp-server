...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'processProcedureFormat', labelKey: 'processProcedure', width: 107, align: 'left',},
  {value: 'programNumber', labelKey: 'programNumber', width: 58},
  {value: 'debugMinute', labelKey: 'debugMinute', width: 71},
  {value: 'clampingMinute', labelKey: 'clampingMinute', width: 71},
  {value: 'assistMinute', labelKey: 'assistMinute', width: 71},
  ...
  {value: 'countHour12', labelKey: 'countHour12', width: 110},
