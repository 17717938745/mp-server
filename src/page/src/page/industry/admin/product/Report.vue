...
import Account from './report/Account.vue'
import Device from './report/Device.vue'
...
const componentList = ref([
  {
    label: store.state.label.reportManage,
    component: shallowRef(Index),
  },
  {
    label: store.state.label.reportSummaryAccount,
    component: shallowRef(Account),
  },
  {
    label: store.state.label.reportSummaryDevice,
    component: shallowRef(Device),
  },
]);
let tabIndex
try {
