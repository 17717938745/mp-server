...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'deviceIdFormat', labelKey: 'device', width: 150, mergeKey: ['deviceId']},
  ...
  {value: 'deviceDeviceCompletePercentFormat', labelKey: 'reportDeviceCompletePercent', width: 115,},
  {value: 'deviceDeviceUsePercentFormat', labelKey: 'reportDeviceUsePercent', width: 109,},
  {value: 'devicePercentDiffFormat', labelKey: 'reportDiff', width: 71,},
  {value: 'sumDeviceCompletePercentFormat', labelKey: 'reportSumDeviceCompletePercent', width: 115, mergeKey: ['deviceId']},
  {value: 'sumDeviceUsePercentFormat', labelKey: 'reportSumDeviceUsePercent', width: 112, mergeKey: ['deviceId']},
  {value: 'totalCount', labelKey: 'totalCount', width: 71, mergeKey: ['deviceId']},
  {value: 'userIdCount', labelKey: 'userCount', width: 71, mergeKey: ['deviceId']},
  {value: 'reportDateCount', labelKey: 'reportDateCount', width: 57, mergeKey: ['deviceId']},
  {value: 'deviceCompletePercentFormat', labelKey: 'reportDeviceCompletePercent', width: 115, mergeKey: ['deviceId']},
