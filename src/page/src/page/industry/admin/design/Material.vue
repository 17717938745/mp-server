...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'customerOrderNo', labelKey: 'customerOrderNo', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'customerProjectSequence', labelKey: 'customerProjectSequence', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'saleOrderNo', labelKey: 'saleOrderNo', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'orderProjectNo', labelKey: 'orderProjectNo', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'materialNo', labelKey: 'materialNo', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  ...
  {value: 'designNumber', labelKey: 'designNumber', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'orderCount', labelKey: 'orderCount', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'productionDate', labelKey: 'productionDate', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'promiseDoneDate', labelKey: 'promiseDoneDate', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'blankMaterialNo', labelKey: 'blankMaterialNo', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'blankMaterialDescribe', labelKey: 'blankMaterialDescribe', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'roughcastDesignNumber', labelKey: 'roughcastDesignNumber', width: 189, mergeKey: ['saleOrderNo', 'orderProjectNo', 'productionDate'],},
  {value: 'materialCount', labelKey: 'materialCount', width: 189},
  {value: 'stoveNo', labelKey: 'stoveNo', width: 189},
