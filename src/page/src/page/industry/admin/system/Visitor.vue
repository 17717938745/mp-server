...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'applicantFormat', originValue: 'applicant', labelKey: 'applicant', width: 98},
  {value: 'visitorName', labelKey: 'visitorName', width: 168},
  {value: 'phoneNumber', originValue: 'phoneNumber', labelKey: 'phoneNumber', width: 189, showOverflow: true,},
  {value: 'companyName', originValue: 'companyName', labelKey: 'companyName', width: 189, showOverflow: true,},
  {value: 'visitContent', labelKey: 'visitContent', width: 87},
  ...
  {value: 'visitDepartmentFormat', originValue: 'visitDepartment', labelKey: 'visitDepartment', width: 87},
  {value: 'approverFormat', labelKey: 'approver', width: 87},
  {value: 'valid', labelKey: 'valid', width: 87},
  {value: 'idAndPhotos', labelKey: 'idAndPhotos', width: 189, },
  {value: 'idAndPhotosList', labelKey: 'idAndPhotos', width: 189, type: ValueType.Image,},
  {value: 'remarks', labelKey: 'remarks', width: 189,},
  {value: 'factoryRecords', labelKey: 'factoryRecords', width: 189, },
  {value: 'factoryRecordsList', labelKey: 'factoryRecords', width: 189, type: ValueType.Image,},
  {value: 'visitorFactoryDate', labelKey: 'visitorFactoryDate', width: 189, },
  {value: 'printNumber', labelKey: 'printNumber', width: 189, },
])
...
const state = reactive({
  ...
  formRuleList: {
    ...
    idAndPhotosList: [{required: /*visitorSecurity*/false, type: 'array', min: 1, max: 5}],
    remarks: [{required: visitorSecurity, message: 'Please check', trigger: 'blur'}],
    factoryRecordsList: [{required: /*visitorSecurity*/false, type: 'array', min: 1, max: 5}],
  },
})
