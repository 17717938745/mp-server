...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'applicantFormat', originValue: 'applicant', labelKey: 'applicant', width: 102},
  ...
  {value: 'visitContentFormat', originValue: 'visitContent', labelKey: 'visitContent', width: 161, showOverflow: true,},
  {value: 'expectedVisitTime', labelKey: 'expectedVisitTime', width: 87},
  {value: 'expectedEndTime', labelKey: 'expectedEndTime', width: 87},
  {value: 'contactPersonFormat', originValue: 'contactPerson', labelKey: 'contactPerson', width: 110},
  ...
  {value: 'visitorFactoryDate', labelKey: 'visitorFactoryDate', width: 86,},
  {value: 'printNumber', labelKey: 'printNumber', width: 98,},
])
