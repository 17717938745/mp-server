...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'materialNo', labelKey: 'materialNo', width: 136},
  {value: 'brand', labelKey: 'brand', width: 96},
  {value: 'computerNameFormat', labelKey: 'computerName', width: 148},
  {value: 'model', labelKey: 'computerModel', width: 276, showOverflow: true,},
  // {value: 'username', labelKey: 'username', width: 96},
  {value: 'departmentFormat', labelKey: 'department', width: 168},
  {value: 'userChineseName', labelKey: 'chineseName', width: 179},
  {value: 'professionFormat', labelKey: 'profession', width: 246},
