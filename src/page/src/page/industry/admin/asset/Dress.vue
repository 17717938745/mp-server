...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'applyDate', labelKey: 'applyDate', width: 91},
  ...
  {value: 'descriptionOfOrder', labelKey: 'descriptionOfOrder', width: 210},
  {value: 'storeCount', labelKey: 'storeCount', width: 87},
  {value: 'storeDateDescription', labelKey: 'storeDateDescription', width: 91},
  {value: 'storePictureCount', labelKey: 'storePicture', width: 76,},
