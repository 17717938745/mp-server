...
const columnConfigList = ref<ViewConfig[]>([
  ...
  {value: 'deviceNumber', labelKey: 'deviceNumber', width: 139},
  {value: 'chineseVietnamNameFormat', labelKey: 'chineseVietnamName', width: 159},
  ...
  {value: 'deviceCheckLedgerStateFormat', labelKey: 'state', width: 159},
