...
@ToString
@Data
@TableName("MP_MATERIAL_DETAIL")
@NoArgsConstructor
@ClassFunction("生产工单明细")
@Accessors(chain = true)
public class MaterialDetailEntity extends AbstractAdmin {

    private static final long serialVersionUID = 5945041243096001062L;
    /**
     * 生产工单ID
     */
    @FieldRemark(value = "生产工单ID")
    @Size(max = 64, message = "生产工单ID长度不合法")
