...
public interface AssemblyConverter extends Serializable {
    ...
    @Mapping(target = "modifyTime", expression = "java(com.lead.fund.base.common.util.DateUtil.dateTime(t.getLastModifiedTime(), com.lead.fund.base.common.basic.cons.util.date.DateFormat.DOT_MILLIS, \"--\"))")
