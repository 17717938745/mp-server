...
@ToString
@Data
@TableName("MP_EXAMINE_ATTACHMENT")
@NoArgsConstructor
@ClassFunction("订单检验记录附件")
@Accessors(chain = true)
public class ExamineAttachmentEntity extends AbstractAdmin {
     ...
     * 检验记录id
     */
    @FieldRemark(value = "检验记录id", indexType = "UNIQUE", indexGroup = "0")
    @Size(max = 64, message = "检验记录id长度不合法")
    ...
    /**
     * 附件类型，identification：标识；hardness-硬度；nde-NDE；dimension-尺寸；other-其他
     */
