...
@ToString
@Data
@TableName("MP_INDUSTRY_MAINTAIN_ATTACHMENT")
@NoArgsConstructor
@ClassFunction("事故记录")
@Accessors(chain = true)
public class MaintainAttachmentEntity extends AbstractPrimaryKey {

    private static final long serialVersionUID = -3743197093654400698L;
    /**
     * 维修ID
     */
    @FieldRemark(value = "维修ID", unique = true, constraintGroup = "0")
    @Size(max = 64, message = "维修ID")
