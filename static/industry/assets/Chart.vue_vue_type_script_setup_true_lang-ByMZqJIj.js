import{h as c}from"./main-D46n_dLc.js";const v=Vue.defineComponent({__name:"Chart",setup(d){VueRouter.useRouter(),Vuex.useStore().state.user;const a=Vue.ref(null);Mermaid.initialize({startOnLoad:!1,theme:"default",flowchart:{curve:"basis",target:"_blank"},securityLevel:"loose"});const o=Vue.ref(`
graph TD
